...
<div class="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full dark:bg-gray-900 dark:bg-opacity-50" on:click={close}>
  <div class="relative top-20 mx-auto p-6 border w-full max-w-md shadow-lg rounded-md bg-white dark:bg-gray-800 dark:text-white" on:click|stopPropagation>
    <h2 class="text-2xl font-bold mb-6 text-center dark:text-white">Review {reportType.charAt(0).toUpperCase() + reportType.slice(1)} Report</h2>
    ...
    <div class="space-y-4">
      ...
      <div class="flex justify-between items-center">
        <strong class="text-gray-700 dark:text-gray-300">Reported {reportType === 'user' ? 'User' : 'Offer'}:</strong> 
        <button 
      ...
      <div class="flex justify-between items-center">
        <strong class="text-gray-700 dark:text-gray-300">Reporter:</strong> 
        <button 
          class="text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300"
      ...
      <div>
        <strong class="text-gray-700 dark:text-gray-300">Reason:</strong> 
